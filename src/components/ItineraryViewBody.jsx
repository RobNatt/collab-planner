...
/**
 * Presentational itinerary timeline — no Firebase. Used by ItineraryView (live data)
 * and MarketingUiMocks (static profiles) so screenshot pages work without auth/env.
 */
export default function ItineraryViewBody({
  plan,
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {activity.assignedTo && (
                          <div style={{ fontSize: '12px', color: colors.textMuted, marginTop: '2px' }}>
                            Assigned to: {getUserDisplayName(activity.assignedTo, profiles, viewerUserId)}
                          </div>
                        )}
                      </div>
                      {activity.completed && (
