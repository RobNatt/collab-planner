  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: colors.background, transition: 'background-color 0.3s ease' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 40px 80px' }}>
        ...
        <Section title="4. Payments and Lifetime Deal">
          {p('Collab Planner offers a one-time Lifetime Deal ("LTD") purchase for $49 USD. This grants you access to all current premium features for as long as the Service operates.')}
          {p('All payments are processed securely by Stripe. We do not store your payment card information.')}
          {p('Refund Policy: We offer a 14-day money-back guarantee on LTD purchases. To request a refund, contact us within 14 days of purchase. No refunds will be issued after this period. Refunds are issued at our sole discretion.')}
          {p('"Lifetime" refers to the lifetime of the product, not your personal lifetime. Should the Service be discontinued, LTD holders will be given at least 90 days notice.')}
          {p('We reserve the right to modify pricing and available plans at any time. LTD holders will not be subject to new pricing for features available at the time of their purchase.')}
        </Section>
        ...
        <Section title="14. Termination">
          ...
          {p('You may terminate your account at any time by contacting us. Upon termination, your right to use the Service will immediately cease. LTD purchases are non-refundable after the 14-day refund window.')}
        ...
        <div style={{ padding: '20px', backgroundColor: colors.backgroundTertiary, borderRadius: '10px', marginTop: '20px' }}>
          <p style={{ color: colors.textMuted, fontSize: '13px', margin: 0, lineHeight: '1.6' }}>
            These Terms of Service were last updated on February 18, 2026. By continuing to use Collab Planner after this date, you agree to the current Terms of Service.
          </p>
        </div>
      </div>
    </div>
